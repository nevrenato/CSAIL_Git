...
\sout{\sout{We can't have orphan Blobs, or else, 
there is the possibility for garbage data.} Maybe in the future we can define Blob in Tree.references + Index.stage}
...
is inconsistency in the git "filesystem". \sout{In this case the 
navigational style is more compact than the relation style.}
\begin{lstlisting}

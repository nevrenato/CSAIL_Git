...
\frame{
   ...
   \begin{figure}
      \centering
      \includegraphics[width=1.0\textwidth]{images/CommitAbs1.png}
   \end{figure}
}
...
\frame {
	...
	\begin{figure}
		\centering
		\includegraphics[width=1.0\textwidth]{images/CommitAbs2.png}
	\end{figure}
}
...
\frame {
	...
	\begin{figure}
		\centering
		\includegraphics[width=1.0\textwidth]{images/CommitAbs3.png}
	\end{figure}
}

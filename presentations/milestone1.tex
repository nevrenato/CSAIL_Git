...
\frame{
   \frametitle{Version Control System}
         ...
         \begin{block}{Local VCS}
            No collaboration with others users - RCS %Revision Control System
         \end{block}
         ...
         \begin{block}{Distributed VCS}
            Each client has a mirror of the repository - Git, Mercurial, Bazaar, Darcs%progit 2.1.3
         \end{block}
         \begin{figure}
...
\frame{
   ...
   \begin{block}{First Approach}
      \begin{itemize}
         ...
         \begin{itemize}
            \item Object hash are modeled implicitly
         \end{itemize}
      \end{itemize}
   \end{block}
}
...
\frame{
   ...
   \begin{figure}
      \centering
      \includegraphics[width=0.5\textwidth]{images/commit_with_a_parent.png}
   \end{figure}
}
...
\frame{
   ...
   \begin{figure}
      \centering
      \includegraphics[width=0.7\textwidth]{images/commits_sharing.png}
   \end{figure}
}
...
\frame{
   ...
   \begin{figure}
      \centering
      \includegraphics[width=1\textwidth]{images/structures.png}
   \end{figure}
}
